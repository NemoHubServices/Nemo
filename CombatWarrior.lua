...
local S = loadstring(game:HttpGet("https://raw.githubusercontent.com/NemoHubServices/Nemo/main/source"))()
local T = S:MakeWindow({Name = "Nemo Hub", HidePremium = true})
...
S:MakeNotification({Name = "🐠 Nemo Hub 🐠", Content = "Game: Combat Warrior", Time = 15})
S:Init()

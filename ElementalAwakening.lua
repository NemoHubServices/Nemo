...
local p = loadstring(game:HttpGet("https://raw.githubusercontent.com/NemoHubServices/Nemo/main/source"))()
local q = p:MakeWindow({Name = "Nemo Hub", HidePremium = true})
...
v:AddButton(
    {Name = "Script by Nemo Hub", Callback = function()
            setclipboard("https://discord.gg/QFhWmbaC8M")
        end}
)
v:AddButton(
...
p:MakeNotification({Name = "🐠 Nemo Hub 🐠", Content = "Game: Elemental Awakening ", Time = 15})
p:Init()

...
local u = loadstring(game:HttpGet("https://raw.githubusercontent.com/NemoHubServices/Nemo/main/source"))()
local v = u:MakeWindow({Name = "Nemo Hub", HidePremium = true})
...
u:MakeNotification({Name = "🐠 Nemo Hub 🐠", Content = "Game: Anime Dimension", Time = 15})
u:Init()

...
local s = {1, 2, 3, 4, 5}
local t = loadstring(game:HttpGet("https://raw.githubusercontent.com/NemoHubServices/Nemo/main/source"))()
local u = t:MakeWindow({Name = "Nemo Hub", HidePremium = true})
...
t:MakeNotification({Name = "🐠 Nemo Hub 🐠", Content = "Game: Anime Brawl All Out", Time = 15})
t:Init()
